package com.gaohonglin.day44_01_vitamio_videolist;
...
/**
 * 在页面中显示一个列表，列表的每个item中显示一个文本，一张图片，
 * 当图片被点击时，播放视频
 */
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Integer> list_img = new ArrayList<>();
    ...
    private int[] imgs = {R.mipmap.lyf02,R.mipmap.lyf04,R.mipmap.lyf06_1,R.mipmap.lyf09,R.mipmap.lyf10,R.mipmap.lyf18,R.mipmap.lyf19,R.mipmap.lyf26,R.mipmap.lyf29,R.mipmap.lyf33};
    ...
    private void initData() {
        for (int i = 0; i < 20; i++) {
            ...
            list_img.add(imgs[i%imgs.length]);
        }
    }
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyHolder> {
        ...
        public void onBindViewHolder(final MyHolder holder, final int position) {
            ...
            holder.iv.setImageResource(list_img.get(position));
